...
class Emojifier {
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        if (faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                Bitmap emojiBitmap = getEmojiBitmap(whichEmoji(face), context.getResources());
                if (emojiBitmap == null) {
    ...
    private static @Nullable Bitmap getEmojiBitmap(Emoji emoji, Resources resources) {
        switch (emoji) {
            case SMILE:
                return BitmapFactory.decodeResource(resources, R.drawable.smile);
            case FROWN:
                return BitmapFactory.decodeResource(resources, R.drawable.frown);
            case LEFT_WINK:
                return BitmapFactory.decodeResource(resources, R.drawable.leftwink);
            case RIGHT_WINK:
                return BitmapFactory.decodeResource(resources, R.drawable.rightwink);
            case LEFT_WINK_FROWN:
                return BitmapFactory.decodeResource(resources, R.drawable.leftwinkfrown);
            case RIGHT_WINK_FROWN:
                return BitmapFactory.decodeResource(resources, R.drawable.rightwinkfrown);
            case CLOSED_EYE_SMILE:
                return BitmapFactory.decodeResource(resources, R.drawable.closed_smile);
            case CLOSED_EYE_FROWN:
                return BitmapFactory.decodeResource(resources, R.drawable.closed_frown);
            default:
                return null;
        }
    }
